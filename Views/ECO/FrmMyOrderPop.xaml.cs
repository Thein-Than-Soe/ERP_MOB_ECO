...
namespace CS.ERP_MOB.Views.ECO
{
    ...
    public partial class FrmMyOrderPop : PopupPage
    {
        #region "Declaring"
        ...
        public FrmMyOrderPop(JSN_LOAD_SALE_INVOICE argJSN_LOAD_SALE_INVOICE)
        {
            try
            {
                InitializeComponent();
                BindingContext = mVmlMyOrderLst = new VmlMyOrderLst();
                mVmlMyOrderLst.bindCustomer(argJSN_LOAD_SALE_INVOICE.RES_CUSTOMER_DTL);
