...
namespace CS.ERP_MOB.Views.ECO
{
    ...
    public partial class FrmWishlistPop : PopupPage
    {
        #region "Declaring"
        ...
        public FrmWishlistPop(JSN_LOAD_SALE_INVOICE argJSN_LOAD_SALE_INVOICE)
        {
            try
            {
                InitializeComponent();
                BindingContext = mVmlWishlist = new VmlWishlist();
                mVmlWishlist.bindCustomer(argJSN_LOAD_SALE_INVOICE.RES_CUSTOMER_DTL);
