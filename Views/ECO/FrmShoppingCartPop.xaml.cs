...
namespace CS.ERP_MOB.Views.ECO
{
    ...
    public partial class FrmShoppingCartPop : PopupPage
    {
        #region "Declaring"
        ...
        public FrmShoppingCartPop(JSN_LOAD_SALE_INVOICE argJSN_LOAD_SALE_INVOICE)
        {
            try
            {
                InitializeComponent();
                BindingContext = mVmlShoppingCart = new VmlShoppingCart();
                mVmlShoppingCart.bindCustomer(argJSN_LOAD_SALE_INVOICE.RES_CUSTOMER_DTL);
